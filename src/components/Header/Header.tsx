...
const Header = () => {
  ...
  return !!data ? (
      ...
      <div className="header">
        ...
        <div className="header__button">
          <Link className="link " to={`/new-article`}>
            <button className="header__create-article-button">
              Create article
            </button>
          </Link>
          <Link className="link " to={`/profile`}>
            <div className="header__user-info">
              <div className="header__username">{data?.user.username}</div>
              <img
          ...
          <button className="header__log-out-button" onClick={handleClick}>
            Log Out
          </button>
        </div>
      </div>
    ...
    <>
      {/* если ключа нет, значит ты не залогинен и видешь */}
      <div className="header">
        <Link to="/">
          <p className="header__title">Realworld Blog</p>
        </Link>
